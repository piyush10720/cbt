        ...
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Create your account to start using CBT Platform
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  className={errors.name ? 'border-destructive' : 'bg-background text-foreground'}
                />
                {errors.name && (
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className={errors.confirmPassword ? 'border-destructive pr-10' : 'pr-10 bg-background text-foreground'}
                  />
                  <button
                    type="button"
